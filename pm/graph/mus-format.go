...
//
// vertexM param defines the Vertex marshaller.
func NewEdgeMarshaller[T any](vertexM *mus.Marshaller[*Vertex[T]]) mus.Marshaller[Edge[T]] {
...
//
// vertexU param defines the Vertex unmarshaller.
func NewEdgeUnmarshaller[T any](vertexU *mus.Unmarshaller[*Vertex[T]]) mus.Unmarshaller[Edge[T]] {
...
//
// vertexS param defines the Vertex sizer.
...
//
// valM param defines the Vertex value marshaller, edgeM - Edge marshaller.
...
//
// valU param defines the Vertex value unmarshaller, edgeU - Edge unmarshaller.
...
//
// valS param defines the Vertex value sizer, edgeS - Edge sizer.
func NewVertexSizer[T any](valS mus.Sizer[T],
	...
	return mus.SizerFn[Vertex[T]](
		func(v Vertex[T]) (size int) {
			...
			return size +
				ord.SizeMap[int, *Edge[T]](v.Edges, mus.SizerFn[int](varint.SizeInt), *edgeS)
		},
	)
}
...
//
// keyM param defines the Vertex key marshaller, valM - Vertex value marshaller.
...
//
// keyU param defines the Vertex key unmarshaller, valU - Vertex value
// unmarshaller.
...
//
// keyU param defines the Vertex key sizer, valU - Vertex value sizer.
